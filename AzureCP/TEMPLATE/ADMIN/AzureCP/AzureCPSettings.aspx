...
<%= String.Format("AzureCP v{0} - <a href=\"{1}\" target=\"_blank\">AzureCP site</a>", FileVersionInfo.GetVersionInfo(Assembly.GetAssembly(typeof(AzureCP)).Location).FileVersion, ClaimsProviderConstants.PUBLICSITEURL) %>
</asp:Content>
