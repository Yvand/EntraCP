...
namespace Yvand
{
    ...
    public class AzureCP : SPClaimProvider
    {
        ...
        /// <summary>
        /// Creates a configuration for AzureCP. This will delete any existing configuration which may already exist
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Deletes the configuration for AzureCP
        /// </summary>
        ...
        /// <summary>
        /// Override this method to inspect the entities generated by AzureCP during a search or a validation operation, and add or remove entities
        /// </summary>
        /// <param name="currentContext">Information about current context and operation</param>
        /// <param name="entities">Entities generated by AzureCP</param>
        /// <returns>Final list of entities that AzureCP will return to SharePoint</returns>
