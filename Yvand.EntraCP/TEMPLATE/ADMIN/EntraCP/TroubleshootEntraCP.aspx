...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <h2>Overview</h2>
    <p>
        This page runs various tests to help you troubleshoot common issues with <a href="https://entracp.yvand.net" target="_blank">EntraCP</a>, in particular those related to the connectivity with Entra ID and the .NET assembly bindings. It is:
    </p>
    <ul>
    ...
    <p>You can also visit <a href="https://entracp.yvand.net/docs/help/troubleshooting/" target="_blank">this page</a> for more troubleshooting steps, and open <a href="https://github.com/Yvand/EntraCP/issues/" target="_blank">an issue</a> if necessary.</p>
    <h2>How-to use it</h2>
    <p>
