...
namespace Yvand.EntraClaimsProvider.Administration
{
    public partial class ClaimTypesConfigUserControl : EntraCPUserControl
    {
        ...
        /// <summary>
        /// Build table that shows mapping between claim types and Microsoft Entra ID objects
        /// </summary>
        ...
        private void BuildAttributesListTable(bool pendingUpdate)
        {
            ...
            th.RowSpan = 2;
            tr.Cells.Add(th);
            th = GetTableHeaderCell("Microsoft Entra ID object details");
            th.ColumnSpan = 3;
            tr.Cells.Add(th);
            ...
            foreach (var attr in this.ClaimsMapping)
            {
                ...
                if (!pendingUpdate)
                {
                    ...
                    else
                    {
                        ...
                        {
                            c = GetTableCell("Microsoft Entra ID object property linked to a PickerEntity metadata");
                        }
                        else
                        {
