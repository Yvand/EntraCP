...
{
    public interface IEntraSettings : IEntityProviderSettings
    {
        /// <summary>
    ...
    public class EntraProviderSettings : EntityProviderSettings, IEntraSettings
    {
    ...
    public class EntraProviderConfig<TSettings> : EntityProviderConfig<TSettings>
