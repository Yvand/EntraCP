...
namespace Yvand.EntraClaimsProvider.Tests
{
    ...
    public class GroupIdentifierIsDisplayNameTests : ClaimsProviderTestsBase
    {
        public override void InitializeSettings()
        {
            base.InitializeSettings();
            Settings.ClaimTypes.UpdateGroupIdentifier(Configuration.DirectoryObjectProperty.DisplayName);
            base.ApplySettings();
        }
